...
<c:set var="listLoaiThuoc" value="${applicationScope.listLoaiThuoc}"/>
				<% 
            ...
            <div class="list-category">
                ...
                <div class="list-category-content">
                    <div class="list-category-content-headline">
                        ...
                        <c:if test="${listLoaiThuoc.size()>0}">
                        	<c:forEach var="item" items="${listLoaiThuoc}">
                            <a href="<c:url value="/chitietloaithuoc?idlt=${item.idLoaiThuoc}"/>">
                                <div class="content-headline">
                                    <p>${item.tenLoaiThuoc}</p>
                                  </div>
                              </a>
                              </c:forEach>
                         	</c:if>      
